...
object Constants {
  ...
  object SecureCommsMessageFields {
    ...
    val CONTACT_NUMBERS = "contactNumbers"
    val PRIMARY_PHONENUMBER = "primaryPhoneNumber"
    val PRIMARY_PHONENUMBER_CHANGED = "primaryPhoneNumberChanged"
    val MOBILE_NUMBER = "mobileNumber"
    val MOBILE_NUMBER_CHANGED = "mobileNumberChanged"
