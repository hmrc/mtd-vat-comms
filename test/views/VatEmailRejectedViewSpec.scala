...
class VatEmailRejectedViewSpec extends ViewBaseSpec {
  ...
  "Rendering the VatEmailRejected secure message content" should {
    ...
    "have the correct second paragraph" in {
      elementText("p:nth-child(3)") shouldBe "If you do not agree with our decision, you can ask for a review by an " +
    ...
    "have the correct HMRC address as the final paragraph" in {
      elementText("div > div > p:nth-child(4)") shouldBe "HMRC VAT Registration Service Crown House Birch " +
