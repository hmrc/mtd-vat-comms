...
class VatOptOutApprovedViewSpec extends ViewBaseSpec {
  ...
  "The opt out approved message" when {
    ...
    "a principal entity has requested to opt out of MTD" should {
      ...
      lazy val view = views.html.vatOptOutApproved()
      ...
      "have the correct second paragraph" in {
        elementText("p:nth-child(2)") shouldBe
          "For your current return period, you must continue to submit your VAT Returns using software compatible with Making Tax Digital."
      }
      ...
      "have the correct fourth paragraph" in {
        elementText("p:nth-child(4)") shouldBe
          "If your taxable turnover goes above £85,000, you must contact us to sign up again for Making Tax Digital."
      }
    }
  }
}
